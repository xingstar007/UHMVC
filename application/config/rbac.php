...
$config['rbac_default_index']        = 'RBAC/menu';   //成功登录默认跳转模块
$config['rbac_manage_menu_hidden']   = array('后台管理');		//后台管理导航中不显示的菜单
$config['rbac_manage_node_hidden']   = array('RBAC');			//后台管理节点中不显示的菜单
$config['rbac_notauth_dirc']         = array('');	     	    //默认无需认证目录array("public","manage")
$config['default_link_icon']         = 'fa fa-edit';
$config['default_menu_icon']         = 'fa fa-dashboard';
